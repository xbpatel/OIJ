package com.xitij.android.oij.view.home.fragment
 ...
 * [InvestorHomeFragment.OnFragmentInteractionListener] interface
...
class InvestorHomeFragment : Fragment() {
     ...
     companion object {
          ...
          fun newInstance(param1 : String , param2 : String) : InvestorHomeFragment {
               val fragment = InvestorHomeFragment()
               val args = Bundle()
